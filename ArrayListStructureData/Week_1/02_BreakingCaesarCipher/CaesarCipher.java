...
public class CaesarCipher {
    ...
    public void encrypt_changed() {
        ...
        // System.out.println(encrypt_changed("At noon be in the conference room with
        // your hat on for a surprise party. YELL LOUD!",15)+"\n");
        // System.out.println(encrypt_changed("At noon be in the conference room with
        // your hat on for a surprise party. YELL LOUD!",8)+"\n");
        // System.out.println(encrypt_changed("At noon be in the conference room with
        // your hat on for a surprise party. YELL LOUD!",21)+"\n");
        System.out.println(
                encrypt_changed("Can you imagine life WITHOUT the internet AND computers in your pocket?", 15) + "\n");
    }
