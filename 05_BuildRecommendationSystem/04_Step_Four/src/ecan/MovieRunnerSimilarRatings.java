...
public class MovieRunnerSimilarRatings {
	...
	public void printAverageRatings() {
		...
		Collections.sort(avgRatingList, new Comparator<Rating>() {
	...
	public static void main(String[] args) {
		...
		//mrs.printAverageRatingsByYearAfterAndGenre();
		//mrs.printSimiliarRatings();
		//mrs.printSimiliarRatingsByGenre();
		//mrs.printSimiliarRatingsByDirector();
		//mrs.printSimiliarRatingsByGenreAndMinutes();
		mrs.printAverageRatingsByYearAfterAndMinutes();
	}
