...
public class EfficientMarkovModel extends AbstractMarkovModel {
	 ...
	 * more efficient, but I am not sure it is more efficient now. Also, the next
	 * method
	 * prints the results and gives the longest key, but it does not return
	 * anything.
	 * There must be something wrong but I do not know why, as the Duke Uni
	 * Assignment 3
	 * exercise given has been so confusing and hard to understand, which is not
	 * connected
	 * to my skills as a programmer but to their skills as teachers, and not in a
	 * good way.
	 */
