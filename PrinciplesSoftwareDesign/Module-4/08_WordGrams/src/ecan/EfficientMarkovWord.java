...
public class EfficientMarkovWord implements IMarkovModel {
	...
	// The getRandomText method has one integer parameter named numWords. This
	// method
	// generates and returns random text that has numWords words. This method
	// generates
	// each word by randomly choosing a word from the training text that follows the
	// current word(s) in the training text. When you copied the body of
	// EfficientMarkovWordOne
	// into the EfficientMarkovWord class, you copied this method from
	// EfficientMarkovWordOne. Much of
	// the code from the copied method will still be correct for
	// EfficientMarkovWord, but you
	// will need to make a few changes so that it works for any order (not just
	// order
